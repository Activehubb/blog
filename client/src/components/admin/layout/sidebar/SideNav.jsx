...
const SideNav = () => {
	...
	return (
		<div className='flex-3 hidden lg:block static'>
					<div className='static'>
						<div className=' py-3 bg-gray-900  text-white text-center font-medium text-2xl w-full'>
							<Link to='/admin'>Ademola ArtWork</Link>
						</div>
						<div className='mt-10'>
